...
export const metadata: Metadata = {
  title: "Cookie Policy & Privacy Preferences — LOOMIE",
  description:
...
export default function CookiesPage() {
  return (
    <main className="relative min-h-screen bg-[#050505] text-white overflow-hidden select-none">
      <Navbar />

      {/* Hero Header */}
      <SubpageHeroHeader
        badge="[LOOMIE - LEGAL & PRIVACY]"
        line1="COOKIE POLICY &"
      ...
      <section className="py-16 sm:py-24 px-6 sm:px-12 md:px-16 max-w-4xl mx-auto w-full space-y-12">
        <div className="space-y-4 border-b border-white/15 pb-8">
          <div className="flex items-center gap-2 font-mono text-xs font-bold text-[#f75828] uppercase tracking-widest">
            <Cookie className="w-4 h-4 text-[#f75828]" />
            <span>COOKIE CONSENT & PRIVACY FRAMEWORK</span>
          </div>
          <h1 className="text-3xl sm:text-5xl font-light font-sans tracking-tight text-white">
            Cookie Policy
          </h1>
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-4 font-sans text-sm">
            <div className="p-6 bg-stone-900 border border-white/15 rounded-xl space-y-2 shadow-2xs">
              <div className="flex items-center justify-between">
                <span className="font-mono text-xs font-bold text-white uppercase tracking-wider">
                  ESSENTIAL & TECHNICAL COOKIES
                </span>
                <span className="font-mono text-[10px] font-bold text-emerald-400 bg-emerald-950 px-2 py-0.5 rounded-xs border border-emerald-800">
                  REQUIRED
                </span>
              </div>
            ...
            <div className="p-6 bg-stone-900 border border-white/15 rounded-xl space-y-2 shadow-2xs">
              <div className="flex items-center justify-between">
                ...
                <span className="font-mono text-[10px] font-bold text-stone-300 bg-white/10 px-2 py-0.5 rounded-xs border border-white/20">
                  OPTIONAL
                </span>
              </div>
              <p className="text-stone-300 leading-relaxed text-xs sm:text-sm">
        ...
        {/* Contact Footer Note */}
        <div className="p-6 bg-white/10 border border-white/20 rounded-xl space-y-2 font-mono text-xs text-stone-300">
          <span className="font-bold text-white uppercase block">QUESTIONS ABOUT PRIVACY?</span>
          <p>
            For privacy inquiries or data requests, contact our privacy officer at{" "}
            <a href="mailto:privacy@loomie.design" className="underline font-bold text-[#f75828]">
