...
const PROJECTS_DATA: Record<string, ProjectDetail> = {
  "crunchy-brand": {
    ...
    nextTitle: "LOGO DESIGN",
    nextHeroImage: getCloudinaryUrl("/images/services/service-color.jpg"),
    nextCategory: "Logo & Brand Identity",
  },
  "banana-health": {
    slug: "banana-health",
    title: "LOGO DESIGN",
    category: "Logo & Brand Identity",
    subtitle: "Bespoke logomark geometry, visual brand tokens, color palettes, and comprehensive identity systems.",
    client: "LOOMIE STUDIO",
    year: "2026",
    services: ["Logo Design", "Visual Identity", "Color Tokens", "Brand Architecture", "Typography Systems"],
    heroImage: getCloudinaryUrl("service-color.jpg"),
    challenge:
      "Modern brands require an iconic, memorable visual identity and logomark that commands instant recognition across physical packaging, digital applications, and spatial architecture.",
    solution:
      "LOOMIE engineers precision logomark geometry, tailored color palettes, bespoke typographic tokens, and comprehensive brand guidelines engineered for long-term brand equity.",
    impact:
      "+210% brand recall, sub-100ms visual recognition, and 98.4% brand satisfaction across digital and physical touchpoints.",
    gallery: [
