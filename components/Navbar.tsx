    ...
    <>
      ...
      >
        <div className="max-w-[1700px] mx-auto px-6 md:px-12 flex items-center justify-between">
          ...
          <nav
            className={`hidden lg:flex items-center gap-8 xl:gap-12 text-base md:text-lg font-sans transition-all duration-500 transform ${
              scrolled
          ...
          <div className="flex items-center justify-end">
            ...
            <a
              href="/contact"
              className={`hidden md:inline-flex px-7 py-3 rounded-none bg-foreground text-background font-bold text-base transition-all duration-500 hover:bg-white hover:text-black items-center gap-2.5 shadow-md border border-foreground group transform ${
                scrolled
            ...
            <button
              onClick={toggleMenu}
              className={`px-4 py-3 sm:px-6 sm:py-3.5 rounded-none bg-surface-card border-2 border-border-custom text-foreground transition-all duration-500 hover:border-foreground hover:bg-foreground hover:text-background items-center gap-2.5 shadow-md group transform ${
                scrolled
                  ? "opacity-100 translate-y-0 pointer-events-auto flex"
