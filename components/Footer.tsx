          ...
          <div>
            ...
            <div className="flex flex-wrap items-center gap-3 font-mono text-xs font-bold text-[#0E0E0E]">
              <a
                ...
                className="px-3.5 py-2 border border-stone-300 rounded-full bg-white hover:bg-[#0E0E0E] hover:text-white transition-all duration-300 shadow-xs flex items-center gap-2 group"
              >
