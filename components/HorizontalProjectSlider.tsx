...
const AKARU_PROJECTS: AkaruProject[] = [
  ...
  },
  {
    ...
    slug: "banana-health",
    title: "Logo Design",
    category: "2026 • LOGO DESIGN & BRANDING",
    subCategory: "VISUAL IDENTITY & BRAND TOKENS",
    brandStory: "Bespoke logomark geometry, visual brand tokens, color palettes, and comprehensive identity systems.",
    brandStory2: "LOOMIE engineers precision logomark geometry, tailored color palettes, bespoke typographic tokens, and brand guidelines.",
    year: "2026",
